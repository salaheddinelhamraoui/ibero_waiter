...
const TicketCard = ({ openedTicket, setOpenedTicket, ticketId, bg }) => {


  return (
    <TouchableOpacity
      className={`${bg ? bg : 'bg-white'} mt-4 rounded-[20px] px-4 py-2 mb-2 z-8 ${openedTicket === ticketId ? 'mb-6' : ''}`}
      onPress={() => {
    ...
    >
      ...
      {
        openedTicket === ticketId &&
        <View className="absolute -bottom-8 bg-red right-4 rounded-b-[20px] left-8 z-1 px-4 py-1">
